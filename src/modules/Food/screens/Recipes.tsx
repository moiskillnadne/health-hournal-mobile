...
import { Box, Row, FlatList, Pressable, Spinner, Text } from 'native-base';
import { useNavigate, useLocation } from 'react-router-native';
import { useDebounce } from 'use-debounce';

import { useFetchFoodRecipesQuery } from '@features/MediaContent';
import { Article } from '@features/MediaContent/types';
import { GridSwitcher, useListView } from '@features/Lists';
import { Header, BackArrow, Search, Content, ArticleCard } from '@app/components';
...
function Recipes() {
  ...
  const {
    ...
    loadMore,
    isFetching,
  } = useInfiniteScroll<Article>(useFetchFoodRecipesQuery, {
    take: 50,
  ...
  return (
    <Box flex={1}>
      ...
      <Content my={4} flex={1}>
        ...
        {articles.length === 0 && debouncedSearchText && !isFetching ? (
