...
function TermsOfUseModal(props: Exclude<IModalProps, 'children'>) {
  const t = useCommonTranslate();

  const body = `Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a
  ...
  their exact original form, accompanied by English versions from the 1914 translation by
  H. Rackham.`;

  return <InfoModal title={t('titles.terms_of_use')} body={body} {...props} />;
}
